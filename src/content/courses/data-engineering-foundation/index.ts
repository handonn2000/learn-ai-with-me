...
export const dataEngineeringFoundation: Course = {
  ...
  topicLabels: {"def12.dependencies": "Dependency và trạng thái", "def12.reruns": "Retry và backfill", "def12.airflow": "Airflow và XCom", "def12.resources": "Concurrency và pool", "def12.quality": "Chất lượng và contract", "def12.gates": "Validation gate và lineage", "def7.sources": "Nguồn dữ liệu", "def7.cdc": "CDC", "def7.kafka": "Kafka và consumer groups", "def7.delivery": "Độ bền và delivery", "def7.retention": "Retention và Debezium", "def8.storage": "Các kiểu lưu trữ", "def8.cache": "Bộ nhớ và cache", "def8.hdfs": "Đọc dữ liệu HDFS", "def8.modeling": "Các mức mô hình dữ liệu", "def8.schemas": "Star và snowflake", "def8.lake": "Data lake và warehouse", "def8.governance": "Quản trị dữ liệu", "def8.lakehouse": "Lakehouse", "def8.medallion": "Bronze, silver và gold"},
  code: 'DEF',
  ...
  description: 'Một tệp dữ liệu chạy được trên máy bạn mới là điểm bắt đầu. Tôi sắp xếp 12 bộ slide AIDE-01 / EDAI–FSDS thành lộ trình đi từ Linux, Python và SQL đến ingestion, storage, batch/stream, consumption và orchestration. Tuần 7, 8 và 12 đã có bài Ingestion, Storage và Orchestration song ngữ, lab mô phỏng và quiz; các tuần còn lại đang ở dạng khung học.',
  baseline: {
    ...
    scope: 'Bản này gồm mục tiêu, điều kiện đầu vào, thứ tự học và mốc thực hành dự kiến. Tuần 7, 8 và 12 đã có bài học, lab mô phỏng và quiz. Các tuần khác và bài kiểm tra tổng hợp chưa được tạo. Kubernetes chuyên sâu, vận hành cloud và huấn luyện ML nằm ngoài phần bắt buộc.',
