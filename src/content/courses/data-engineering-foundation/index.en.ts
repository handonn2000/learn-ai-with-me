...
export const dataEngineeringFoundationEn: Course = {
  ...VI,
  topicLabels: {"def12.dependencies": "Dependencies and state", "def12.reruns": "Retries and backfills", "def12.airflow": "Airflow and XCom", "def12.resources": "Concurrency and pools", "def12.quality": "Quality and contracts", "def12.gates": "Validation gates and lineage", "def7.sources": "Data sources", "def7.cdc": "CDC", "def7.kafka": "Kafka and consumer groups", "def7.delivery": "Durability and delivery", "def7.retention": "Retention and Debezium", "def8.storage": "Storage types", "def8.cache": "Memory and caches", "def8.hdfs": "Reading HDFS data", "def8.modeling": "Data modeling levels", "def8.schemas": "Star and snowflake", "def8.lake": "Data lakes and warehouses", "def8.governance": "Data governance", "def8.lakehouse": "Lakehouse", "def8.medallion": "Bronze, silver, and gold"},
  org: 'Self-study notebook · DEF',
  subtitle: 'A proposed 12-week roadmap · 12 sessions · 4 parts · foundations to data pipelines',
  description: 'Getting a data file to work on your laptop is the starting point. I organized the 12 AIDE-01 / EDAI–FSDS slide decks into a path from Linux, Python, and SQL through ingestion, storage, batch/stream processing, consumption, and orchestration. Weeks 7, 8, and 12 include bilingual Ingestion, Storage, and Orchestration lessons, simulation labs, and quizzes; the other weeks remain course outlines.',
  baseline: {
    ...
    scope: 'This version defines outcomes, prerequisites, learning order, and proposed practice milestones. Weeks 7, 8, and 12 have lessons, simulation labs, and quizzes. Other detailed lessons and course tests are not created yet. Advanced Kubernetes, cloud operations, and ML training are outside the required scope.',
