export const VI = {
  ...
  chapters: [
    ...
    },
    {
      ...
      cards: [
        { title: 'Một hợp đồng đủ để hành động', text: 'Với Orders: order_id không rỗng; amount là số hữu hạn không âm, đơn vị VND; owner là đội Sales Data; độ mới và retention có ngưỡng được thống nhất. Dòng vi phạm đi quarantine kèm lý do, owner nhận cảnh báo, downstream thấy rõ dữ liệu nào chưa được chấp nhận.' }
      ],
      table: {
    ...
    },
    {
      ...
      body: [
        ...
        'Fixture của bài giữ 5 dòng bronze: order_id 101 với amount 120000; một retry giống hệt 101; order_id 102 với 80000; order_id 103 có amount sai kiểu; và một dòng thiếu order_id với 50000. Quy tắc chấp nhận đòi khóa không rỗng và amount là số hữu hạn không âm tính bằng VND. Kết quả là <strong class="def-conclusion">2 đơn silver, 2 dòng quarantine, 1 duplicate và gold 200000 VND</strong>. Số đếm khớp 5 dòng đầu vào; không dòng lỗi nào âm thầm biến mất.',
