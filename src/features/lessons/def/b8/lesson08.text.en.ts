...
export const EN = {
  ...
  chapters: [
    ...
    },
    {
      ...
      cards: [
        { title: 'A contract you can act on', text: 'For Orders: order_id must be present; amount is a finite, nonnegative number in VND; Sales Data owns it; freshness and retention have agreed limits. Violations go to quarantine with reasons, the owner receives alerts, and downstream users can see what hasn\'t been accepted.' }
      ],
      table: {
