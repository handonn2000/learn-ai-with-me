...
**Authoring update · 2026-09-07:** the user has requested lessons 7–12 (Parts III and IV) first, with every substantive slide detail, documentary narration, visual interactions, and both Vietnamese and English. The [lesson design review](lesson-design/README.md) supersedes the later authoring order below for this work and expands those six lessons beyond the lighter foundation treatment. Weeks 7–12 now have implementations. Weeks 9–11 were added on 2026-09-26, each with ten chapters, three browser labs, ten quiz questions, and VI/EN presentation mode. See [validation](reviews/b9-b11-validation.md).
